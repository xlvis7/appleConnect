        ...
        link: function(scope, element, attrs, ngModel) {
          ...
          if (ngModel) {
            ...
            scope.$watch(attrs.ngModel+'.length', function() {
              ...
              $timeout(function() {
                if (element.hasClass("ui-sortable")) { // this check prevents "Error: cannot call methods on sortable prior to initialization; attempted to call method 'refresh'". It's not a sortable till "ui-sortable" class is present.
